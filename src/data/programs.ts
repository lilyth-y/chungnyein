...
export const programs: Program[] = [
  ...
  },
  {
    ...
    benefit:
      '훈련비 90% 이상 지원(자기부담금 최대 60만 원, 내일배움카드 잔액은 최대 300만 원까지만 차감·초과분은 국비) + 훈련장려금 월 최대 20만 원, 일부 과정 특별훈련수당 10~60만 원 추가',
  ...
  },
  {
    ...
    target: '공고일 기준 경기도에 거주하는 18~39세 미취업 청년 (연간 약 250~450명 규모, 회차·공고별 상이)',
    benefit: '직업상담사 1:1 맞춤형 컨설팅, 이력서·자기소개서 첨삭, 면접코칭, 면접캠프, AI 모의면접, 전·현직자 멘토링 등',
    period: '연 2회 모집 (1차 3월, 2차 8월 예정 - 선착순 조기마감 가능 · 2차 상담·연계는 통상 9~11월)',
    howToApply: [
    ...
    tags: ['취업컨설팅', '면접코칭', '멘토링'],
    status: 'seasonal',
    note: '2026년 2차(8월) 모집의 정확한 접수 마감일·잔여 인원은 이번 조사에서 공고문 원문을 확인하지 못했습니다. 신청 전 잡아바 어플라이 최신 공고를 확인하세요.',
  },
  {
  ...
  },
  {
    ...
    tags: ['자산형성', '저축지원', '재직청년'],
    status: 'seasonal',
    note: '경기도청 공식 안내상 2026년 모집일정은 하반기 예정(미정)입니다. 과거 회차(예: 8월 접수) 일정과 혼동하지 않도록 공고 게시 후 신청하세요.',
  },
  {
    ...
    period: '2026년 모집 2026.7.1~7.13 진행·마감 (통상 연 1회, 차기 연도 공고 확인)',
    howToApply: [
    ...
    sources: [
      {
        label: '청년 노동자 지원사업(youth.jobaba.net) - 2026년 복지포인트 모집 안내',
    ...
    status: 'seasonal',
    note: '2026년 신규 모집은 7.13에 마감되었습니다. 선정자 대상 ‘청년 노동자 지원 플러스’(금융교육·배달특급 쿠폰 등)가 별도 운영될 수 있으니 youth.jobaba.net 공지를 확인하세요.',
  },
  {
