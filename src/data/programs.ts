...
export const programs: Program[] = [
  ...
  },
  {
    ...
    title: '두루누리 사회보험료 지원(고용보험·국민연금)',
    category: 'corporate',
    region: 'national',
    agency: '고용노동부·근로복지공단·국민연금공단',
    applicant: 'both',
    summary:
      '상시근로자 10인 미만 소규모 사업장이 저임금 근로자를 새로 채용해 4대보험에 가입시키면, 사업주와 근로자 부담분 고용보험·국민연금 보험료의 80%를 최대 36개월간 지원합니다.',
    target:
      '근로자 수 10인 미만 사업장(전년도 및 신청월 말일 기준) · 월평균보수 270만 원 미만이면서 신청일 직전 1년간 고용보험·국민연금 자격취득 이력이 없는 신규가입 근로자와 해당 사업주 (근로자 재산세 과세표준 합계 6억 원 미만, 종합소득 연 4,300만 원 미만)',
    benefit:
      '고용보험·국민연금 보험료(사업주 부담분 + 근로자 부담분)의 80%를 최대 36개월간 지원 · 지원신청일이 속한 달 보험료부터 적용되며, 완납 시 다음 달 고지서에서 자동 차감 · 매년 말 근로자 수 10인 미만 요건을 유지하면 별도 재신청 없이 자동 연장',
    period: '상시 신청 (마감일 없음, 통상 4대보험 취득신고와 동시 신청)',
    howToApply: [
      '신규 채용 근로자의 4대보험 취득신고(피보험자격취득신고서 등) 진행 시 "두루누리 사회보험료 지원 희망" 항목 체크로 동시 신청',
      '이미 가입된 사업장은 4대사회보험 정보연계센터(4insure.or.kr)에 사업장 회원으로 로그인 후 "두루누리 보험료 지원" 메뉴에서 신청',
      '온라인 신청이 어려운 경우 사업장 소재지 관할 근로복지공단(고용보험) 또는 국민연금공단(국민연금) 지사에 방문·우편·팩스로 서류 제출',
    ],
    documents: [
      '(미가입 사업장) 보험관계성립신고서, 피보험자격취득신고서(또는 근로내용확인신고서)',
      '(기가입 사업장) 두루누리 사회보험료 지원신청서',
      '사업자등록증 사본, 근로계약서 등 보수 확인 서류',
    ],
    contact: '근로복지공단 1588-0075(고용보험) · 국민연금공단 1355(국민연금)',
    sources: [
      {
        label: '두루누리 사회보험 - 근로자 사회보험료 지원 소개',
        url: 'http://insurancesupport.or.kr/durunuri/intro.php',
      },
      {
        label: '4대사회보험 정보연계센터 (온라인 신청 포털)',
        url: 'https://www.4insure.or.kr',
      },
    ],
    tags: ['4대보험', '사회보험료지원', '소규모사업장', '저임금근로자'],
    note: '지원율(80%)과 기준 보수(270만 원)는 매년 고시로 조정될 수 있으므로, 신청 전 4대사회보험 정보연계센터 공고에서 해당 연도 기준을 다시 확인하세요.',
  },
  {
